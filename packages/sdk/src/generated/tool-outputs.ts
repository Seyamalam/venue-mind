...
export interface VenueMindToolOutputMap {
  ...
  "venue.inspect_post_event_review": {
    review: VenueMindPostEventReview;
    comparisons: {
      key: string;
      prediction: {
        key: string;
      ...
      status: "matched" | "better" | "worse" | "insufficient-evidence";
      delta: number | null;
      tolerance: number;
...
export interface VenueMindPostEventReview {
  ...
  baseline: {
    ...
    occupancyMonitor: VenueMindLiveOccupancyMonitor1;
    occupancyProjection: VenueMindLiveOccupancyProjection1;
    incidentRegister: VenueMindIncidentRegister1;
    deviationRegister: VenueMindLivePlanDeviationRegister1;
    scenarioRuns: {
      [k: string]: unknown;
    }[];
    fingerprint: string;
...
export interface VenueMindLiveOccupancyMonitor1 {
  schemaVersion: 1;
  id: string;
  projectId: string;
  runbookVersionId: string;
  ...
  feeds: VenueMindAggregateOccupancySignal1[];
  observations: {
    [k: string]: unknown;
  }[];
  activeAlerts: {
...
export interface VenueMindAggregateOccupancySignal1 {
  sourceId: string;
  sourceType: "registration" | "sensor" | "manual-counter";
  sourceVersion: string;
  kind: "check-in" | "zone-occupancy";
...
export interface VenueMindLiveOccupancyProjection1 {
  monitorId: string;
  runbookVersionId: string;
  evaluatedAt: string;
  overallStatus: "unavailable" | "nominal" | "warning" | "exceeded" | "conflicting" | "stale";
...
export interface VenueMindIncidentRegister1 {
  schemaVersion: 1;
  id: string;
  projectId: string;
  runbookVersionId: string;
  ...
  incidents: VenueMindOperationalIncident1[];
  transitions: {
    [k: string]: unknown;
  }[];
  receipts: {
...
export interface VenueMindOperationalIncident1 {
  schemaVersion: 1;
  id: string;
  revision: number;
  severity: "low" | "medium" | "high" | "critical";
  ...
  location: VenueMindIncidentLocationContext1;
  owner: {
    [k: string]: unknown;
  } | null;
  /**
...
export interface VenueMindIncidentLocationContext1 {
  kind: "plan-object" | "coordinate";
  planId: string;
  planVersion: string;
  planFingerprint: string;
...
export interface VenueMindLivePlanDeviationRegister1 {
  schemaVersion: 1;
  id: string;
  projectId: string;
  runbookVersionId: string;
