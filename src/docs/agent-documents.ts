...
const publicHref = (href: string, origin: string): string => href.startsWith("/") && origin ? new URL(href, origin).href : href;
...
export function buildAgentDocuments({ origin: originValue = "", skillPackages = [] }: { origin?: string; skillPackages?: readonly AgentSkillPackageSummary[] } = {}): AgentDocuments {
