import { BROWSER_EXAMPLE_SUMMARY, CLIENT_CONFIGS, CODEX_TOML, HOST_WORKFLOWS } from "../../examples/client-catalog.js";
...
export const clientExamplesPage = {
  ...
  compatibility: ["Tool contract 1.3.0", "MCP server 0.5.0"],
  sections: [
    {
      id: "webmcp",
