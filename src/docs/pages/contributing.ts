...
export const contributingPage = {
  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        links({ label: "TypeScript SDK", href: "/guides/sdk.md" }, { label: "Adapter authoring", href: "/guides/adapter-authoring.md" }, { label: "SDK API reference", href: "/sdk-api.json" }, { label: "Schema migration guide", href: "/guides/schema-migrations.md" }, { label: "Database operations", href: "/guides/database-operations.md" }, { label: "Real-time collaboration", href: "/guides/realtime-collaboration.md" }, { label: "Sharing and notifications", href: "/guides/sharing-and-notifications.md" }, { label: "Registration and ticketing", href: "/guides/registration-and-ticketing.md" }, { label: "Operational resources", href: "/guides/operational-resources.md" }, { label: "Threat model", href: "/guides/threat-model.md" }, { label: "Resource limits", href: "/guides/resource-limits.md" }, { label: "Release process", href: "/guides/release-process.md" }, { label: "Release checklist", href: "/guides/release-checklist.md" }, { label: "Production hosting", href: "/guides/production-hosting.md" }, { label: "Failure recovery runbook", href: "/guides/runbooks/failure-recovery.md" }, { label: "Security reporting policy", href: "/guides/security.md" }, { label: "Published guide manifest", href: "/guides/manifest.json" }),
      ],
    },
    {
      id: "decisions",
