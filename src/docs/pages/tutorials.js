...
export const tutorialPages = [
  ...
  tutorialPage({
    ...
    sections: [
      { id: "preview", title: "Preview before import", blocks: [steps("Open /projects and select IMPORT.", "Choose public/examples/venuemind-project-package.json from the repository.", "Review the package ID, checksum, migration report, stable-ID checks, geometry checks, Lock checks, ledger integrity, and replay status.", "Confirm the Project ID does not already exist.")] },
