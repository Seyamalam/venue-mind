...
export const contributingPage = {
  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        links({ label: "Canonical spatial frame", href: "/guides/adr/0003-canonical-spatial-frame.md" }, { label: "Human Roles and Agent Grants", href: "/guides/adr/0017-human-roles-and-agent-grants.md" }, { label: "Shared runtime contracts", href: "/guides/adr/0018-shared-runtime-contracts.md" }, { label: "Constraint registry", href: "/guides/adr/0019-versioned-constraint-registry.md" }, { label: "Ledger integrity and replay", href: "/guides/adr/0020-hash-chained-ledger-and-replay.md" }, { label: "Sites identity and tenancy", href: "/guides/adr/0021-sites-identity-and-server-owned-tenancy.md" }, { label: "Hashed bearer sharing", href: "/guides/adr/0024-hashed-bearer-sharing.md" }, { label: "Operational Resource Snapshots", href: "/guides/adr/0025-operational-resource-snapshots-are-not-plan-truth.md" }, { label: "Public SDK boundary", href: "/guides/adr/0026-public-sdk-follows-canonical-tool-and-adapter-contracts.md" }),
      ],
    },
  ],
};
