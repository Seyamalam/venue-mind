...
const emptyObject: any = { type: "object", properties: {}, additionalProperties: false };
const mutationMetadataProperties: any = {
...
const commandExecutionMetadataProperties: any = {
...
const restrictionMetadataSchema: any = {
  type: "object",
...
const occupancyPolicySchema: any = {
  type: "object",
...
const placementMetadataSchema: any = {
  type: "object",
...
const circulationMetadataSchema: any = {
  type: "object",
  properties: {
...
const staffPostMetadataSchema: any = {
  type: "object",
...
const utilityMetadataSchema: any = {
  type: "object",
...
const riggingMetadataSchema: any = {
  type: "object",
...
const productionZoneMetadataSchema: any = {
  type: "object",
  required: ["access"],
...
const productionMetadataSchema: any = {
  type: "object",
...
const cateringMetadataSchema: any = {
  type: "object",
  required: ["type"],
  properties: {
...
const emergencyMetadataSchema: any = {
  type: "object",
  required: ["type"],
  properties: {
...
const emergencyReviewSchema: any = {
  type: "object",
...
const resourceBindingSchema: any = {
  type: "object",
...
export const validationResultSchema = {
  ...
  properties: {
    ...
    evidenceFamilyFingerprints: {
      ...
      properties: Object.fromEntries(["accessibility", "capacity", "catering", "emergency", "flow", "operations", "production", "sightlines"].map((family: any) => [family, { type: "string", pattern: `^evidence-${family}-[0-9a-f]{8}$` }])),
      additionalProperties: false,
    },
...
export const proposalComparisonSchema = {
  ...
  properties: {
    ...
    objectDeltas: {
      ...
      properties: Object.fromEntries(["addedObjectIds", "removedObjectIds", "movedObjectIds", "rotatedObjectIds", "resizedObjectIds", "metadataObjectIds"].map((key: any) => [key, { type: "array", items: { type: "string" } }])),
      additionalProperties: false,
    },
    acceptedDeltas: {
      type: "object",
...
const eventBriefRequirementSchema: any = eventBriefSchema.properties.requirements.items;
const eventScheduleSchema: any = eventBriefSchema.properties.schedule.anyOf[1];
const planningEffectSourceSchema: any = {
  type: "object",
...
const planningEffectProperties: any = {
...
const commentAnchorInputSchema: any = {
  type: "object",
  required: ["kind"],
  properties: {
...
const simulationCurvePointSchema: any = { type: "object", required: ["second", "cumulativeShare"], properties: { second: { type: "number", minimum: 0 }, cumulativeShare: { type: "number", minimum: 0, maximum: 1 } }, additionalProperties: false };
const mobilityProfileSchema: any = { type: "object", required: ["id", "share"], properties: { id: { type: "string", minLength: 1 }, label: { type: "string" }, share: { type: "number", exclusiveMinimum: 0, maximum: 1 }, speedFactor: { type: "number", exclusiveMinimum: 0 }, accessibleRouteRequired: { type: "boolean" } }, additionalProperties: false };
const ingressEgressInputSchema: any = {
  type: "object",
  properties: {
...
const occupancyAlertSchema: any = {
  type: "object",
...
const liveOccupancyResultSchema: any = { type: "object", required: ["monitor", "projection"], properties: { monitor: liveOccupancyMonitorSchema, projection: liveOccupancyProjectionSchema, receipt: { type: "object" }, duplicate: { type: "boolean" } }, additionalProperties: false };
const liveOccupancyExportSchema: any = { type: "object", required: ["filename", "mimeType", "content"], properties: { filename: { type: "string", minLength: 1 }, mimeType: { const: "application/json" }, content: { type: "string" } }, additionalProperties: false };

const incidentSeveritySchema: any = { enum: ["low", "medium", "high", "critical"] };
const incidentCategorySchema: any = { enum: ["accessibility", "crowd-capacity", "medical", "security", "fire-life-safety", "facilities", "production-av", "catering", "staffing", "transport", "weather", "other"] };
const incidentLocationInputSchema: any = {
  oneOf: [
...
const incidentResultSchema: any = { type: "object", required: ["register"], properties: { register: incidentRegisterSchema, incidents: { type: "array", items: operationalIncidentSchema }, incident: operationalIncidentSchema, receipt: { type: "object" }, duplicate: { type: "boolean" } }, additionalProperties: false };
const incidentExportSchema: any = { type: "object", required: ["filename", "mimeType", "content"], properties: { filename: { type: "string", minLength: 1 }, mimeType: { const: "application/json" }, content: { type: "string" } }, additionalProperties: false };

const projectSummarySchema: any = {
  type: "object",
...
const baseVenueToolContracts: any = [
  {
...
const authorizationScopeForTool: any = (name: any) => {
...
const limitsForTool: any = (name: any) => Object.freeze({
...
const exampleInputForTool: any = (name: any) => (({
...
const errorsForTool: any = (name: any, contract: any) => {
  const errors: any = ["TOOL_SCOPE_REQUIRED", "AUTHORIZATION_DENIED", "AGENT_GRANT_INVALID", "TOOL_PAYLOAD_TOO_LARGE", "TOOL_CALL_CANCELLED", "VENUE_INTERNAL_ERROR"];
...
const outputSchemaForTool: any = (name: any) => (({
...
export const venueToolContracts = Object.freeze(baseVenueToolContracts.map((contract: any) => Object.freeze({
  ...contract,
  title: contract.name.split(".").at(-1).split("_").map((word: any) => word[0].toUpperCase() + word.slice(1)).join(" "),
...
const persistedProposalSchema: any = {
  type: "object",
...
export function commandForVenueTool(name: any, input: any = {}, source: any = "agent-tool") {
