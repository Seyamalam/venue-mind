...
import type { DomainRecord } from "./ui-types";
import "./shared-review.css";

type SharedReviewProps = { token: string };
type SharedReviewState = { status: "LOAD" | "READY" | "UNAVAILABLE"; data: DomainRecord | null };
