...
export const LOCAL_VERIFICATION_PHASES = Object.freeze([
  ...
  npmScript("hosting-config", "Production hosting configuration", "verify:hosting"),
  npmScript("vercel-build", "Vercel Next.js build", "build:next"),
  nodeScript("frontend-platform", "Next.js frontend boundary", "scripts/verify-next-platform.mjs"),
