...
const guideSources = [
  ...
  ["docs/sdk.md", "sdk.md", "TypeScript SDK"],
  ["docs/adapter-authoring.md", "adapter-authoring.md", "Adapter authoring"],
  ["docs/compatibility-and-deprecation.md", "compatibility-and-deprecation.md", "SDK compatibility and deprecation"],
