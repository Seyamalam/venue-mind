...
| Persistence and worker  | `node --test tests/project-store.test.mjs tests/incident-store.test.mjs tests/incident-routes.test.mjs tests/database-migrations.test.mjs` | remote authority, local recovery, API routing, database upgrade/restore |
